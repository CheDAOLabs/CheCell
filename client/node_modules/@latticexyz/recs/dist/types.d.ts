...
export declare enum QueryFragmentType {
    Has = 0,
    HasValue = 1,
    Not = 2,
    NotValue = 3,
...
export type QueryFragment<T extends Schema = Schema> = HasQueryFragment<T> | HasValueQueryFragment<T> | NotQueryFragment<T> | NotValueQueryFragment<T> | ProxyReadQueryFragment | ProxyExpandQueryFragment;
export type EntityQueryFragment<T extends Schema = Schema> = HasQueryFragment<T> | HasValueQueryFragment<T> | NotQueryFragment<T> | NotValueQueryFragment<T>;
 ...
 */
export type OverridableComponent<S extends Schema = Schema, M extends Metadata = Metadata, T = undefined> = Component<S, M, T> & {
    addOverride: (overrideId: string, update: Override<S, T>) => void;
    removeOverride: (overrideId: string) => void;
};
export type OptionalType = Type.OptionalNumber | Type.OptionalBigInt | Type.OptionalString | Type.OptionalEntity | Type.OptionalNumberArray | Type.OptionalBigIntArray | Type.OptionalStringArray | Type.OptionalEntityArray;
export declare function isOptionalType(t: Type): t is OptionalType;
export type ArrayType = Type.NumberArray | Type.OptionalNumberArray | Type.BigIntArray | Type.OptionalBigIntArray | Type.StringArray | Type.OptionalStringArray | Type.EntityArray | Type.OptionalEntityArray;
export declare function isArrayType(t: Type): t is ArrayType;
export type NumberType = Type.Number | Type.OptionalNumber;
export declare function isNumberType(t: Type): t is NumberType;
export type EntityType = Type.Entity | Type.OptionalEntity;
export declare function isEntityType(t: Type): t is EntityType;
export type Layer = {
    world: World;
