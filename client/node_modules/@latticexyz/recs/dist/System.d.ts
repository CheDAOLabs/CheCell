 ...
 */
export declare function defineRxSystem<T>(world: World, observable$: Observable<T>, system: (event: T) => void): void;
/**
 ...
 * }
 */
export declare function defineUpdateSystem(world: World, query: QueryFragment[], system: (update: ComponentUpdate) => void, options?: {
    runOnInit?: boolean;
}): void;
/**
 ...
 * }
 */
export declare function defineEnterSystem(world: World, query: QueryFragment[], system: (update: ComponentUpdate) => void, options?: {
    runOnInit?: boolean;
}): void;
/**
 ...
 * }
 */
export declare function defineExitSystem(world: World, query: QueryFragment[], system: (update: ComponentUpdate) => void, options?: {
    runOnInit?: boolean;
}): void;
/**
 ...
 * }
 */
export declare function defineSystem(world: World, query: QueryFragment[], system: (update: ComponentUpdate & {
    type: UpdateType;
}) => void, options?: {
    runOnInit?: boolean;
}): void;
 ...
 * }
 */
export declare function defineComponentSystem<S extends Schema>(world: World, component: Component<S>, system: (update: ComponentUpdate<S>) => void, options?: {
    runOnInit?: boolean;
}): void;
/**
 ...
 */
export declare function defineSyncSystem<T extends Schema>(world: World, query: QueryFragment[], component: (entity: EntityIndex) => Component<T>, value: (entity: EntityIndex) => ComponentValue<T>, options?: {
    update?: boolean;
    runOnInit?: boolean;
}): void;
